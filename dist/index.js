...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.fetchSteamWishList = void 0;
const fetchSteamWishList = (args) => __awaiter(void 0, void 0, void 0, function* () {
...
const fetchSteamWishList_1 = __nccwpck_require__(9346);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const fetchSteamWhishList = (arg, page = 0) => __awaiter(this, void 0, void 0, function* () {
                ...
                console.log(url);
                if (!result) {
                    throw new Error(`No successful whishlist fetch for ${arg.steamProfileId}`);
                }
            ...
            const withPrice = yield (0, fetchSalesDataFromProductId_1.fetchSalesDataFromProductId)({
                fetchData: ({ productId }) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const { result } = yield withRetryDelay({
